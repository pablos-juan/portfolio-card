  ...
  return (
    <main className='flex items-center justify-center h-full w-full'>
      <section className='bg-green-600/20 w-full md:w-200 h-fit rounded-2xl p-4 gap-4 md:gap-0 border-7 border-green-600 shadow-xl/20 flex flex-col items-center justify-center'>
        <article className='flex flex-col md:flex-row items-center gap-6 p-4 rounded hover:scale-105 transition-all duration-200'>
          <img
            src='/avatar.webp'
            alt='avatar'
        ...
        <div className='flex flex-col md:flex-row gap-4 md:gap-0 h-fit w-full'>
          <section className='flex flex-col-reverse md:flex-col justify-center gap-2 md:px-4 rounded hover:scale-105 transition-all duration-200 md:w-2/3'>
            <div className='flex flex-col md:flex-row gap-3'>
              <article className='border-1 border-neutral-500/80 rounded md:w-1/2 h-20 flex items-end w-full' />
              <article className='border-1 border-neutral-500/80 rounded md:w-1/2 h-20 flex items-end w-full' />
            </div>
          ...
          <section className='flex h-fit flex-col justify-center gap-1 p-4 rounded hover:scale-105 transition-all duration-200 md:w-1/3'>
